...
def print_help():
    ...
    print("\nAvailable commands:")
    print(
        "  /query <text> or q <text>    - Query the knowledge base with natural language"
    )
    ...
    print(
        "  /ingest <file> or i <file>  - Process and ingest a file into the knowledge base"
    )
    print(
        "  /remove <file> or r <file>  - Remove a file and its embeddings from the database"
    )
    ...
    print(
        "You can provide just the filename or relative path within the documents folder."
    )
...
def remove_file_interactive(file_path):
    ...
    print(
        f"Deleted file metadata. Orphaned chunk IDs deleted from ChromaDB: {orphaned_chunks}"
    )
...
def test_path_resolution():
    ...
    test_cases = [
        ...
        (
            "sub/folder/file.docx",
            "E:/Github/samvaad/data/documents/sub/folder/file.docx",
        ),
        (
            "E:/Github/samvaad/data/documents/sample.pdf",
            "E:/Github/samvaad/data/documents/sample.pdf",
        ),
