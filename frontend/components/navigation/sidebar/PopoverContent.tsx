import type { GroupedConversations } from "@/hooks/useGroupedConversations";
...
export function PopoverContent({
	...
	const totalItems = grouped
		? (conversations as GroupedConversations).today.length +
			...
			Object.values((conversations as GroupedConversations).months).reduce(
		...
		<div className="py-2 max-h-[400px] overflow-y-auto">
			...
			{grouped ? (
				<>
					...
					{renderGroup(
						"Yesterday",
						(conversations as GroupedConversations).yesterday,
					)}
					{renderGroup(
						"Previous 7 Days",
						(conversations as GroupedConversations).previous7Days,
					)}
