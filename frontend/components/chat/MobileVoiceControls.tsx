            ...
            >
                <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-1">
                    <div className="flex items-center justify-between border-b border-white/10 pb-3">
                        <span className="text-sm font-semibold text-white/90">Voice Settings</span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                            <div className={cn(
                                ...
                                {enableTTS ? <AudioLines className="w-4 h-4" /> : <Slash className="w-4 h-4 rotate-90" />}
                            </div>
                            <div className="flex flex-col items-start">
                                <span className={cn("text-xs font-semibold", enableTTS ? "text-white" : "text-text-secondary")}>
                                    {enableTTS ? "Voice to Voice" : "Voice to Text"}
                                </span>
                                <span className="text-[10px] text-white/40">
                                    {enableTTS ? "Agent speaks" : "Text replies"}
                                </span>
                            </div>
                        </button>
                    ...
                    <div className="space-y-4 pt-2 border-t border-white/10">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-xs font-medium text-white/50">{getVolumePercentage()}%</span>
                            </div>
                            <input
                                type="range"
