...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
	(
		...
		const variants = {
			default:
				"bg-surface text-text-primary border border-white/10 hover:bg-white/5 hover:border-white/20 shadow-sm",
			destructive:
			...
			signal:
				"bg-signal/10 text-signal border border-signal/20 hover:bg-signal/20 shadow-[0_0_15px_rgba(16,185,129,0.1)]",
		};
